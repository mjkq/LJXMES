...
namespace DataHelper.Mysql
{

    public class MySqlHelper
    {
        // 连接数据库
        private string connectString = string.Empty;//一个有效的连接字符串
        ...
        public MySqlHelper()
        {
            connectString = ConfigurationManager.ConnectionStrings["MySql"].ToString();
        }
        ...
        public string ExecuteReader(CommandType cmdType, string cmdText, params MySqlParameter[] commandParameters)
        {
            //创建一个MySqlCommand对象
            MySqlCommand cmd = new MySqlCommand();
